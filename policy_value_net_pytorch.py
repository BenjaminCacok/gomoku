...
class PolicyValueNet:
    ...
    def __init__(self, board_width, board_height,
        ...
        if model_file:
            if model_file == 'best_policy_8_8_5.model2':
                param_theano = pickle.load(open('best_policy_8_8_5.model2', 'rb'))
                keys = ['conv1.weight', 'conv1.bias', 'conv2.weight', 'conv2.bias', 'conv3.weight', 'conv3.bias',
                        'act_conv1.weight', 'act_conv1.bias', 'act_fc1.weight', 'act_fc1.bias', 'val_conv1.weight',
                        'val_conv1.bias', 'val_fc1.weight', 'val_fc1.bias', 'val_fc2.weight', 'val_fc2.bias']
